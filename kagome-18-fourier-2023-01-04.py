...
def main():
    ...
    for J2 in [
        ...
        system = HeisenbergJ1J2(KagomeLattice(width=2, height=3), J1=1, J2=J2, use_symmetries=True)
        ...
        ground_state = system.get_df_eigenstate(k=0).assign(prob=lambda x: x["amplitude"] ** 2)
