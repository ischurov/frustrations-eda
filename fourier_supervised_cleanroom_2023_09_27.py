...
configs = {
    0: {"lattice": "kagome2x4"},
    1: {"lattice": "kagome3x3"},
    2: {"lattice": "square6x4", "J2s": np.linspace(0, 1, 41)},
    3: {"lattice": "triangle6x4", "J2s": np.linspace(0, 1.4, 15)},
    4: {"lattice": "square7x4"},
    5: {"lattice": "triangle7x4", "J2s": np.linspace(0, 1.4, 15)},
    6: {"lattice": "square6x5"},
    7: {"lattice": "triangle6x5", "J2s": np.linspace(0, 1.4, 15)},
    8: {"lattice": "kagome2x4", "sampling_power_train": 1.0},
