...
def main(task_id: int):
    n_samples_list = [1000]
    energy_baseline_list = [10.0, 250.0]
    lattice_list = [KagomeLattice(2, 3)]
    epochs_list = [100]

    configs = [
        (1000, 10.0, KagomeLattice(2, 3), 100, False),
        (1000, 250.0, KagomeLattice(2, 3), 100, False),
        (1000, 10.0, KagomeLattice(2, 3), 100, True),
        (1000, 250.0, KagomeLattice(2, 3), 100, True),
        (1000, 10.0, KagomeLattice(2, 3), 1000, True),
    ]
    n_samples, energy_baseline, lattice, epochs, reset_network = configs[task_id % len(configs)]
