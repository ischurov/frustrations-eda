...
def main(task_id: int):
    n_samples_list = [1000]
    energy_baseline_list = [None, 0.0, 250.0]
    lattice_list = [KagomeLattice(2, 3)]
    epochs_list = [100, 1000]

    configs = list(product(n_samples_list, energy_baseline_list, lattice_list, epochs_list))
    n_samples, energy_baseline, lattice, epochs = configs[task_id]
