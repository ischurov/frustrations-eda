...
eps_trains = [1e-3, 5e-3, 1e-2, 1e-1]
...
def write_terms_to_file(
    ...
    prediction = series.truncate(keep_largest_n(terms)).predict()
    ...
    row.update(scores)
    row["rel_weight_terms"] = terms
    row["rel_weight_total_hamming_weight"] = series.total_hamming_weight(terms)
    ...
    row["target_rel_weight"] = target_rel_weight
            ...
            for eps_train in eps_trains:
                ...
                for epoch, net, loss in train_net(
                    ...
                    write_terms_to_file(
                        ...
                        target_rel_weight=target_rel_weight,
                        params={"J2": J2, "eps_train": eps_train, "epoch": epoch},
                    )
