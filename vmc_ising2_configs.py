...
configs = {
    ...
    16: {
        "system.lattice": "triangular6x4",
        "system.J2": 1.3,
        "log_prob_fn": "invariant_cnn",
        "log_prob_fn.invariant_cnn.hidden_channels": [32, 32, 32],
        "log_prob_fn.invariant_cnn.kernel_size": 3,
        "vmc.lr": 0.05,
        "vmc.max_steps": 200,
        "system.symmetry_basis": "zero_sector",
        "vmc.eval_set_max_size": 5000,
        "warm_up.vmc_true_signs.overlap": 1.0,
        "warm_up.vmc_true_signs.max_steps": 1000,
        "warm_up.vmc_true_signs.outer_sample_size": 1_00,
        "warm_up.vmc_true_signs.inner_sample_size": 1_00,
        "warm_up.vmc_true_signs.inner_epochs": 1,
        "sign_reconstruction.extension_steps": 1,
        "runs": 20,
    },
    17: {
        "_inherit": 16,
        "log_prob_fn.invariant_cnn.dilations": [3, 2, 1],
        "runs": 20,
    },
    18: {
        "_inherit": 16,
        "log_prob_fn.invariant_cnn.dilations": [1, 2, 3],
        "runs": 20,
    },
    19: {
        "system.lattice": "triangular6x4",
        "system.J2": 1.3,
        "log_prob_fn": "invariant_cnn",
        "log_prob_fn.invariant_cnn.hidden_channels": [4, 4, 4],
        "log_prob_fn.invariant_cnn.kernel_size": 3,
        "vmc.lr": 0.05,
        "vmc.max_steps": 200,
        "system.symmetry_basis": "zero_sector",
        ...
        "warm_up.vmc_true_signs.overlap": 1.0,
        "warm_up.vmc_true_signs.max_steps": 1000,
        "warm_up.vmc_true_signs.outer_sample_size": 1_000,
        "warm_up.vmc_true_signs.inner_sample_size": 1_000,
        "warm_up.vmc_true_signs.inner_epochs": 1,
        "sign_reconstruction.extension_steps": 1,
        "runs": 20,
    },
    20: {
        ...
        "system.J2": 1.3,
        "log_prob_fn": "invariant_cnn",
        "log_prob_fn.invariant_cnn.hidden_channels": [4, 4],
        "log_prob_fn.invariant_cnn.kernel_size": 3,
        "vmc.lr": 0.05,
        "vmc.max_steps": 200,
        "system.symmetry_basis": "zero_sector",
    ...
    21: {
        ...
        "system.J2": 1.3,
        "log_prob_fn": "invariant_cnn",
        "log_prob_fn.invariant_cnn.hidden_channels": [2, 2, 2],
        "log_prob_fn.invariant_cnn.kernel_size": 3,
        "vmc.lr": 0.05,
        "vmc.max_steps": 200,
        "system.symmetry_basis": "zero_sector",
