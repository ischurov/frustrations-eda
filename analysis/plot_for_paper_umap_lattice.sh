...
#SBATCH --output=/vol/tcm11/kravchenko/to_scratch/frustrations-eda-main/logs/slurm-%j.out
#SBATCH --error=/vol/tcm11/kravchenko/to_scratch/frustrations-eda-main/logs/slurm-%j.err
